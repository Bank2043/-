...
<body>
    ...
    <div class="dashboard-main-wrapper">
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="logout.php" data-toggle="model" data-target="#logoutModel" onclick="return confirm('คุณต้องการออกจากระบบหรือไม่ ?')"><i class="fas fa-power-off mr-2"></i>ออกจากระบบ</a> 
        ...
        <div class="dashboard-wrapper">
            ...
            <img src="../img/admin.jpg" class="center" width="900" height="600">
